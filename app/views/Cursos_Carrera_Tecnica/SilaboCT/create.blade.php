...
{{ Form::open(array('method'=> 'POST','url'=> 'SilaboCarreraTecnica/insert.html','class'=>'form-horizontal','role'=>'form')) }}
	...
	<div class="col-sm-8">
		{{ Form::hidden('codCargaAcademica_ct',$id,array('class'=>'form-control','placeholder'=>'','required','readonly'=>'readonly'))}}
	</div></div>
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			...
			@else
				{{ Form::hidden('orden',SilaboCursoTecnico::get()->last()->orden +1 ,array('class'=>'form-control','readonly'=>'readonly'))}}
			@endif
		</div>
			<div class="errores">
			@if ( $errors->has('orden'))
	...
	<div class="form-group">
		<div class="col-xs-12 col-sm-8 col-md-5">
			{{HTML::linkAction('ListarCursosCTController@getIndex', 'Cancelar','',array('class'=>'col-sm-12 btn btn-warning'))}}
		</div>
		<div class="col-xs-12 col-sm-8 col-md-5">
