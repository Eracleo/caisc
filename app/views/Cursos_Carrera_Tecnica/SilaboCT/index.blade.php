...
@stop
@section('breadcrumb')
<li>Silabo Cursos de Carrera</li>
@stop
<style>
    span {
        margin: 5px;
        ...
        <div id="example1_wrapper" class="dataTables_wrapper form-inline" role="grid">
            ...
            <tbody aria-relevant="all" aria-live="polite" role="alert">
                ...
                <tr class="odd">
                        ...
                        <td class=" ">
                           <span class = "label label-success">{{ HTML::link('SilaboCarreraTecnica/detalle/'.$dato->id,'Detalle') }}</span> 
                           <br><br>
                           <span class = "label label-warning">{{ HTML::link('SilaboCarreraTecnica/updatecID/'.$dato->id,'Actualizar') }} </span> 
                           <br><br>
                           <span class = "label label-danger"> {{ HTML::link('SilaboCarreraTecnica/post_delete/'.$dato->id,'Eliminar') }}</span> 
                        </td>
                </tr>
                @endforeach
                </tbody>
